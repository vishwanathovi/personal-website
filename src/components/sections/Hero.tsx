    ...
    >
      ...
      <Container className="relative z-10">
        <div className="flex flex-col gap-3 sm:gap-4 lg:gap-4">
          <div className="isolate grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:gap-x-10 lg:gap-y-6">
            <div className="relative z-10 order-2 flex min-w-0 flex-col lg:order-1">
            ...
            <div className="relative z-0 order-1 flex w-full justify-center self-start shrink-0 lg:order-2 lg:w-auto lg:justify-start">
